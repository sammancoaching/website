...
You call it _Ensemble Programming_ when you're working on a programming task, and _Ensemble Testing_ when it's a testing task. Generally we call it _Ensemble Working_, or simply _Ensemble_.

The term _Ensemble Programming_ is a synonym for [Mob Programming](https://en.wikipedia.org/wiki/Mob_programming) or [Software Teaming](https://woodyzuill.com/home/software-teaming-mob-programming/). In Samman Coaching, we prefer to use the word "Ensemble" (see notes below). 
