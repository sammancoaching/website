...
### Concrete
Write some test cases for some existing code that already basically works. For example [CalcStats](https://github.com/emilybache/CalcStats-TestDesign-Kata). Be sure to structure your test cases using Arrange - Act - Assert. If you find any bugs in the code, please fix them.
