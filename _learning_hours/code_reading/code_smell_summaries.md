...
Demonstrate what you want them to do by giving a 2-3 minute presentation about a code smell, for example ["Shotgun Surgery"]({% link _code_smells/shotgun_surgery.md %}).
...
Give people a chance to think quietly and write a note for themselves. For example [explain the main idea]({% link _activities/conclusions/explain_main_idea.md %}) of code smells.
